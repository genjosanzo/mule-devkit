...
public class MuleModuleBuilderHelper {
    ...
    public MuleModuleBuilderHelper(MavenId projectId,
    ...
    private void generateFromArchetype(final Project project, final VirtualFile pom) {
        ...
        props.put("muleModuleName", myModuleName);
        props.put("muleModulePackage", myModulePackage);
