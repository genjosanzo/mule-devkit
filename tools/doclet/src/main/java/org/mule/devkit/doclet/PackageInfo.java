...
public class PackageInfo extends DocInfo implements ContainerInfo {
    ...
    public static ClassInfo[] filterNonModules(ClassInfo[] classes) {
        ArrayList<ClassInfo> out = new ArrayList<ClassInfo>();
    ...
    public ClassInfo[] modules() {
        if (mModules == null) {
            mModules =
                    ClassInfo.sortByName(filterHidden(filterNonModules(Converter.convertClasses(mPackage.ordinaryClasses()))));
        }
        return mModules;
    }
