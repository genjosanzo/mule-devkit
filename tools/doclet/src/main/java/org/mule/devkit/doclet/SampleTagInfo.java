...
public class SampleTagInfo extends TagInfo {
    ...
    private SampleLanguage mLanguage;
    ...
    SampleTagInfo(String name, String kind, String text, SampleLanguage lang, ContainerInfo base,
    ...
    public SampleLanguage getmLanguage() {
        return mLanguage;
    }

    public void setmLanguage(SampleLanguage mLanguage) {
