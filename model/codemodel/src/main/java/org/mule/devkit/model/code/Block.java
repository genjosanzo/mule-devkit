...
public final class Block implements Generable, Statement {
    ...
    public Invocation invoke(Expression expr, Method method) {
        return insert(new Invocation(expr, method));
    }
    ...
    public Conditional _if(Expression expr) {
        return insert(new Conditional(expr));
    }
    ...
    public SwitchStatement _switch(Expression test) {
        return insert(new SwitchStatement(test));
    }
    ...
    public TryStatement _try() {
        return insert(new TryStatement());
    }
    ...
    public void _return(Expression exp) {
        insert(new ReturnStatement(exp));
    }
