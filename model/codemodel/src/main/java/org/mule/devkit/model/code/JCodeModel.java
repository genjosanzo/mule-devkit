...
public final class JCodeModel {
    ...
    public JCodeModel(CodeWriter codeWriter) {
     ...
     */
    public DefinedClass _class(String fullyqualifiedName) throws JClassAlreadyExistsException {
     ...
     * @throws JClassAlreadyExistsException When the specified class/interface was already created.
     */
    public DefinedClass _class(int mods, String fullyqualifiedName, ClassType t) throws JClassAlreadyExistsException {
     ...
     * @throws JClassAlreadyExistsException When the specified class/interface was already created.
     */
    public DefinedClass _class(String fullyqualifiedName, ClassType t) throws JClassAlreadyExistsException {
    ...
    private class JReferencedClass extends JClass implements JDeclaration {
        ...
        public JPrimitiveType getPrimitiveType() {
            ...
            if (v != null)
                return parse(JCodeModel.this, v.getName());
            else
                return null;
        }
