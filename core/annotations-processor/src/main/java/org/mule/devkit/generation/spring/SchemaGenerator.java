            ...
            if( connectExecutableElement != null ) {
                for (VariableElement connectVariable : connectExecutableElement.getParameters()) {
                    if (context.getTypeMirrorUtils().isCollection(connectVariable.asType())) {
                        generateCollectionElement(targetNamespace, all, connectVariable, true);
                    } else {
                        complexContentExtension.getAttributeOrAttributeGroup().add(createParameterAttribute(connectVariable, true));
                    }
                }
            }
        }
        ...
        if (connectMethod != null) {
            ...
            for (VariableElement connectVariable : connectMethod.getParameters()) {
                if (context.getTypeMirrorUtils().isCollection(connectVariable.asType())) {
                    ...
                    config.getAttributeOrAttributeGroup().add(createParameterAttribute(connectVariable, true));
                }
            }
