...
public class ModuleAnnotationProcessorTest extends AbstractAnnotationProcessorTest {
    ...
    */
    ...
    public void moduleAnnotationAtInterfaceInvalid() {
        assertCompilationReturned(Diagnostic.Kind.ERROR, 23, compileTestCase(InvalidTypeInterface.class));
    }

    @Test
    public void moduleAnnotationAtGenericInvalid() {
        assertCompilationReturned(Diagnostic.Kind.ERROR, 23, compileTestCase(InvalidTypeGeneric.class));
    }

    @Test
    public void moduleAnnotationPrivateInvalid() {
        assertCompilationReturned(Diagnostic.Kind.ERROR, 23, compileTestCase(InvalidTypeNonPublic.class));
    }

    @Test
    public void fieldAnnotationFinalInvalid() {
        assertCompilationReturned(Diagnostic.Kind.ERROR, 26, compileTestCase(InvalidFieldFinal.class));
    }
}
