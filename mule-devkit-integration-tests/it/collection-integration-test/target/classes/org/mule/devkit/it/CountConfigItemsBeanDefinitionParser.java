...
public class CountConfigItemsBeanDefinitionParser
    extends ChildDefinitionParser
{


    public CountConfigItemsBeanDefinitionParser() {
        super("messageProcessor", CountConfigItemsMessageProcessor.class);
    }

    protected Class getBeanClass(Element element) {
        return CountConfigItemsMessageProcessor.class;
    }
