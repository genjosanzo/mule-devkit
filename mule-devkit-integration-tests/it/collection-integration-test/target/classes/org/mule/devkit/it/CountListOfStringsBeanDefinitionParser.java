...
public class CountListOfStringsBeanDefinitionParser
    extends ChildDefinitionParser
{


    public CountListOfStringsBeanDefinitionParser() {
        super("messageProcessor", CountListOfStringsMessageProcessor.class);
    }

    protected Class getBeanClass(Element element) {
        return CountListOfStringsMessageProcessor.class;
    }
