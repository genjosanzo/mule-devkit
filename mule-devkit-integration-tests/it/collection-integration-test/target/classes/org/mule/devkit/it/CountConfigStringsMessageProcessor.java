...
public class CountConfigStringsMessageProcessor
    implements MuleContextAware, Initialisable, MessageProcessor
{
        ...
        throws MuleException
    {
        ...
        try {
            ...
            resultPayload = object.countConfigStrings();
            ...
            throw new MessagingException(CoreMessages.failedToInvoke("countConfigStrings"), event, e);
        }
    }
