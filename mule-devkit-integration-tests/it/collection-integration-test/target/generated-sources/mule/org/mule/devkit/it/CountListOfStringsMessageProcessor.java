...
public class CountListOfStringsMessageProcessor
    implements MuleContextAware, Initialisable, MessageProcessor
{
        ...
        throws MuleException
    {
        ...
        try {
            ...
            resultPayload = object.countListOfStrings(strings);
            ...
            throw new MessagingException(CoreMessages.failedToInvoke("countListOfStrings"), event, e);
        }
    }
